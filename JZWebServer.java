...
public class JZWebServer {
	...
	try {
	    ...
	    sHandler.addServlet(new ServletHolder(new CustomerServlet()),"/customer");
	    // We want the form URL /admin to go to AdminServlet
	    sHandler.addServlet(new ServletHolder(new AdminServlet()),"/admin");
	    sHandler.addServlet(new ServletHolder(new FetchDataServlet()),"/FetchDataServlet");
	    sHandler.addServlet(new ServletHolder(new QueryServlet()),"/QueryServlet");
